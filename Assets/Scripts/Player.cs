...
public class Player : MonoBehaviour
{
    ...
    void Update()
    {
        vx = Input.GetAxisRaw("Horizontal");   //  GetAxisRaw 부드럽게

        if (vx < 0 )    //  if문 2개 제로일 때 변하지 않음
        {
        ...
        //  총알 발사
        if(Input.GetButtonDown("Fire1"))// && lastShoot + 0.5f < Time.time)  // 쿨타임
        {
